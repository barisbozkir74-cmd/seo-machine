    ...
    <div className="flex flex-1 flex-col min-h-0">
      ...
      <SplitPane
        ...
        right={
          <ModuleAIPanel
            variant="sidebar"
            title="Entegrasyon Yöneticisi"
            managerName="Entegrasyon Uzmanı"
            hint="Aktif bağlantıları izler, veri akışlarını kontrol eder ve entegrasyon sorunlarını tespit eder."
